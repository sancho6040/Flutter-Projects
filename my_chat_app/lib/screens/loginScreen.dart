import 'package:my_chat_app/screens/homePage.dart';
...
class _LoginScreenState extends State<LoginScreen> {
    ...
    if (!_isLogin) {
      return Padding(
        ...
        child: TextFormField(
          ...
          validator: (text) => text!.isEmpty ? "El nombre es requerido " : "",
        ),
      );
    } else {
      return Container();
  ...
  Widget secondaryButton() {
    String buttonText =
        _isLogin ? "Create an account" : "Access with your account";
    return TextButton(
        onPressed: () {
          setState(() {
            _isLogin = !_isLogin;
  ...
  Future submit() async {
    ...
    try {
      if (_isLogin) {
        ...
        _userId = await authentication.signUp(
